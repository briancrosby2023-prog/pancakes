    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            if name or pos:
                ...
                for c in cs[:100]: rows.append(_player_search_row(c,gm.rank_by_id.get(c["card_id"],{})))
