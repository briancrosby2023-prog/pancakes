...
def test_gemini_client_has_explicit_bounded_timeout(monkeypatch, tmp_path):
    ...
    payload = {
        ...
        "slots": {
            "LT1": {
                "starter": {"observed_name": "Josh Petty", "displayed_ovr": 80},
                "backups": [],
            },
            "RT1": {
                "starter": {"observed_name": "Cason Henry", "displayed_ovr": 85},
                "backups": [],
            },
        },
    }
    ...
    translated = GeminiScreenshotTranslator(
        api_key="test-key"
    ).translate_offense_tackles(image)
