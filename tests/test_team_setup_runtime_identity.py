...
assert ocr_team_app_visual.TEAM_SETUP_BUILD == 'CFB27-TACKLE-VISUAL-PATH-1'
assert team_app.TEAM_SETUP_BUILD == 'CFB27-TACKLE-VISUAL-PATH-1'
...
assert 'TEAM SETUP BUILD: CFB27-TACKLE-VISUAL-PATH-1' in surface
